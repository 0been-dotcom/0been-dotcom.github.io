...
<!-- 📸 스크린샷: 완성된 Hermes Agent 실행 화면
     저장 경로: docs/assets/images/posts/2026-05-24-hermes-guide-terminal.png -->
![Hermes Agent 터미널 실행 화면](/assets/images/posts/2026-05-24-hermes-guide-terminal.png)
...
<!-- 📸 스크린샷: 로컬 모델 연결 설정 화면
     저장 경로: docs/assets/images/posts/2026-05-24-hermes-guide-local-model.png -->
![로컬 모델 연결 설정 화면](/assets/images/posts/2026-05-24-hermes-guide-local-model.png)
